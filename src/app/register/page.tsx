      ...
      <div className="bg-transparent rounded-3xl p-8 text-center w-full max-w-md mx-4">
        ...
        <form onSubmit={handleRegister} className="space-y-3 mb-6 text-left">
          ...
          <input
            ...
            className={`w-full border ${password && (!isPasswordMatch || !isPasswordStrong(password)) ? 'border-red-500' : 'border-gray-300'} rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-amber-500 text-gray-800`}
