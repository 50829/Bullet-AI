    ...
    <main className="min-h-screen flex items-center justify-center relative bg-[var(--color-bg-primary)] text-[var(--color-text-primary)]">
      <div className="bg-transparent rounded-3xl p-8 text-center w-full max-w-md mx-4">
        ...
        <button
          ...
          disabled={loading}
          className="w-full px-4 py-2.5 rounded-3xl border border-[#003049] hover:bg-gray-50 text-[var(--color-text-primary)] flex items-center justify-center gap-3 mb-3 transition-colors"
        >
        ...
        <form onSubmit={handleLogin} className="space-y-3 mb-6 text-left">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-4 px-4 py-2.5 rounded-3xl bg-[#003049] text-white font-bold border-2 border-transparent hover:bg-white hover:text-[var(--color-text-primary)] hover:border-[#003049] transition-all duration-300"
          >
