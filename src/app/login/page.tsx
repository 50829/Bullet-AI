...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gray-50 text-gray-800 relative">
      <div className="bg-white rounded-2xl shadow-lg p-8 text-center w-full max-w-md mx-4">
        {/* 语言切换按钮 */}
        <div className="flex justify-center mb-6">
          <button
            onClick={() => setLanguage("en")}
            className={`flex items-center space-x-1 hover:text-orange-500 transition-colors mr-4 ${
          ...
          <button
            ...
            className={`flex items-center space-x-1 hover:text-orange-500 transition-colors ${
              language === "zh" ? "text-orange-500" : "text-gray-500"
            }`}
          >
            <Globe className="w-5 h-5" />
            <span>中文</span>
        ...
        {step === "email" ? (
          <form onSubmit={handleSendCode} className="space-y-3 mb-6 text-left">
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 text-gray-800"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-4 px-4 py-2.5 rounded-xl bg-black text-white font-bold border-2 border-transparent hover:bg-white hover:text-orange-500 hover:border-black transition-all duration-300"
            >
          ...
          <form onSubmit={handleVerifyCode} className="space-y-3 mb-6 text-left">
            ...
            <button
              ...
              className="w-full mt-4 text-orange-500 hover:text-orange-600 hover:underline"
              disabled={loading}
            >
              {t("resendCode")}
            </button>
