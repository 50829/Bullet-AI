...
import { DataV2Database } from "./database";
...
export interface DataV2StoreApi {
...
export class DataV2Store implements DataV2StoreApi {
  ...
  constructor(
    ...
    this.database = new DataV2Database(options.databaseName);
